...
namespace OrthoGes_New_Version
{
    public partial class FormFactures : Form
    {
        ...
        public void ApplyFilters()
        {
            ...
            dgvFactureListe.Columns[2].Width = 140;
            ...
            dgvFactureListe.Columns[7].HeaderText = "Centre Payeur";
            ...
            dgvFactureListe.Columns[8].Width = 160;

            //dgvFactureListe.Columns[13].Visible = false;
            dgvFactureListe.Columns[9].HeaderText = " TTC (Dz)";
            dgvFactureListe.Columns[9].Width = 120;
            ...
            dgvFactureListe.Columns[10].HeaderText = "Date";
            ...
            dgvFactureListe.Columns[10].Width = 90;
        ...
        private void dgvFactureListe_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvFactureListe.Columns[e.ColumnIndex].Name == "etat_Payement")
            {
                ...
                {
                    MessageBox.Show("Échec de la mise à jour du statut de paiement.", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error); return;
                }

                Recouvrement.UpdateEtatPayement(numeroFacture, isPaid ? "OUI" : "NON");
            }
            ...
            if (dgvFactureListe.Columns[e.ColumnIndex].Name == "Payement_cheque")
            {
                ...
                {
                    MessageBox.Show("Échec de la mise à jour du statut de paiement par chèque.", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error); return;
                }

                Recouvrement.UpdatePayementCheque(numeroFacture, isCheque ? "OUI" : "NON");
        ...
        {
            PrintFacturePDF(dgvFactureListe.CurrentRow.Cells[1].Value.ToString());
        }

        private void btnModifier_Click_1(object sender, EventArgs e)
        {
            FormModifierFacture formModifierFacture = new FormModifierFacture(
                dgvFactureListe.CurrentRow.Cells[1].Value.ToString()
            );
