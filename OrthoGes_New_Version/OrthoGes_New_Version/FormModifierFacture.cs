...
namespace OrthoGes_New_Version
{
    public partial class FormModifierFacture : Form
    {
        ...
        public FormModifierFacture(string numero_patient)
        {
            InitializeComponent();
            Numero_Facture = numero_patient;
        }
        ...
        private void tbxReference_TextChanged(object sender, EventArgs e)
        {
            ...
            dv.RowFilter = $"Reference LIKE '%{EscapeLikeValue(tbxReference.Text)}%'";
        ...
        private void btnEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    resultProduits &= Facture.UpdateFacture_Produits(
                        Numero_Facture,
                        oldreference1,
                        tbxReference.Text,
                ...
                {
                    MessageBox.Show("Erreur lors de la modification de la Facture ou des produits.", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            catch (Exception ex)
            {
        ...
        private void tbxReference4_TextChanged(object sender, EventArgs e)
        {
            ...
            DataView dv = produits.DefaultView;
            dv.RowFilter = $"Reference LIKE '%{EscapeLikeValue(tbxReference4.Text)}%'";
