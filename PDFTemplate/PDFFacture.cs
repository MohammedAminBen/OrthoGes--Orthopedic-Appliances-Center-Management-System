...
namespace PDFTemplate
{
    public class PDFFacture
    {
        ...
        // ===== DATA =====
        public static string Num_Facture, Date_Facture;
        ...
        // ===== GENERATOR =====
        public static Document GenerateDocument(string Num_facture, string patientNom, string patientPrenom, string DatenaiPatient, string assureNom, string assurePrenom, string assureDateNai, string numAss, string caisse, string centrePay, string adresse,
                                                       string wilaya, string commune, List<(string Reference, string designation, string PUHT, string Quantity, string Montant_HT, string MontantTVA, string TVA)> produits, string Montant_ttc, string datefacture)
        {
